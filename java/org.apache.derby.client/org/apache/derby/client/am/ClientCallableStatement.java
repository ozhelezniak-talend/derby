...
public class ClientCallableStatement extends ClientPreparedStatement
    ...
    private LocalDate getLocalDate(int parameterIndex) throws SQLException {
        try
        {
            synchronized (connection_) {
                if (agent_.loggingEnabled()) {
                    agent_.logWriter_.traceEntry(
                            this, "getLocalDate", parameterIndex);
                }
                super.checkForClosedStatement();
                checkGetterPreconditions(parameterIndex);
                ...
                if (agent_.loggingEnabled()) {
                    agent_.logWriter_.traceExit(this, "getLocalDate", result);
                }
                return result;
            }
        }
    ...
    private LocalTime getLocalTime(int parameterIndex) throws SQLException {
        try
        {
            synchronized (connection_) {
                if (agent_.loggingEnabled()) {
                    agent_.logWriter_.traceEntry(
                            this, "getLocalTime", parameterIndex);
                }
                super.checkForClosedStatement();
                checkGetterPreconditions(parameterIndex);
                ...
                if (agent_.loggingEnabled()) {
                    agent_.logWriter_.traceExit(this, "getLocalTime", result);
                }
                return result;
            }
        }
    ...
    private LocalDateTime getLocalDateTime(int parameterIndex)
        ...
        try
        {
            synchronized (connection_) {
                if (agent_.loggingEnabled()) {
                    agent_.logWriter_.traceEntry(
                            this, "getLocalDateTime", parameterIndex);
                }
                super.checkForClosedStatement();
                checkGetterPreconditions(parameterIndex);
                ...
                if (agent_.loggingEnabled()) {
                    agent_.logWriter_.traceExit(this, "getLocalDateTime", result);
                }
                return result;
            }
        }
